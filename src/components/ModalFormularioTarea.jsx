...
const ModalFormularioTarea = () => {
    ...
    const {modalFormularioTarea,handleModalFormularioTarea,mostrarAlerta,alerta,nuevaTarea,editarTarea,tarea} = useProyectos()
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <select id="prioridad"
                                            className='border-2 w-full p-2 mt-2 placerholder-gray-400 rounded-md text-center'
                                            value={prioridad}
                                        ...
                                        <input type="submit"
                                         ...
                                         value={`${editando ? "Guardar Cambios":"Crear Tarea"}`} />
