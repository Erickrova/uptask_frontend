...
const ModalFormularioEliminarTarea = () => {

    const {handleModalEliminarTarea,modalEliminarTarea,alerta,tarea,eliminarTarea} = useProyectos()
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <p className='text-md text-gray-700 font-bold'>Las tareas eliminadas no se pueden recuperar</p>
                                    <div className='flex justify-between gap-2 mt-2'>

                                        <button type="button"
                                            className='bg-red-600 hover:bg-red-700 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded'
                                            onClick={handleEliminar}>Sí</button>             
                                        <button type="button"
...
export default ModalFormularioEliminarTarea